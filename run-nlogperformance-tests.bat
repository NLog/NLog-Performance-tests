NLogPerformance\bin\Release\NLogPerformance.exe PerfLogger 15000000 1  16 1 >> performance-log.log
NLogPerformance\bin\Release\NLogPerformance.exe PerfLogger 15000000 1  128 1 >> performance-log.log
